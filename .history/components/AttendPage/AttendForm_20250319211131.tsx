      ...
      <form onSubmit={handleSubmit} ref={formRef} className={styles.form}>
        <div className={styles.form__top}>
          <div className={styles.form__forms}>
            ...
            <FormSelector selections={selections} selectedItem={selectedItem} labeler="How did you hear about ILID 2025?*" errorMessage="Please select an inquiry" selectError={selectError} toggleSelectedItem={toggleSelectedItem}/>
            </div>
          </div>
