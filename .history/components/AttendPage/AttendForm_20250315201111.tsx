          ...
          <div className={styles.checkbox__wrapper}>
            <div className={styles.checkbox}>
              <div className={styles.checkbox__content}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15"><path fill="#fff" fillRule="evenodd" d="M14.707 3L5.5 12.207L.293 7L1 6.293l4.5 4.5l8.5-8.5z" clipRule="evenodd"></path></svg>
                </span>
              </div>
            </div>
