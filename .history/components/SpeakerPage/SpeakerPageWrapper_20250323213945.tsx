...
const SpeakerPageWrapper = () => {
  ...
  const formContent = {
    ...
    keywords: ["Speak"],
    text: "Join us by sharing your expertise and inspiring change. Complete the form below to be considered as a speaker at ILID 2025 or email us at ilid.event@gmail.com",
  };
