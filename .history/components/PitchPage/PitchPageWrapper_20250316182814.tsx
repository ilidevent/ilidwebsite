...
const PitchPageWrapper = () => {
  ...
  const missContent = {
    ...
    text: " We’re seeking visionary students, disruptive start-ups, and creative minds ready to 
reshape Cameroon’s infrastructure landscape. If you have a breakthrough idea and a 
