...
const PitchPageWrapper = () => {
  ...
  const HeroContent = {
    ...
    normalText:
      "Participate in the Innovation Lab, pitch an innovative idea, and unlock the opportunity to secure essential funding for its development. Application ends April 12, 2025, at exactly 11:59 pm",
    buttonProps: {
