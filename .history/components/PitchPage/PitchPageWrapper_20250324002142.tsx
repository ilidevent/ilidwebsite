...
const PitchPageWrapper = () => {
  ...
  const highlight = {
    text: "This year, the ILID Innovation Lab & Pitch Contest shines an even brighter spotlight on groundbreaking innovations and projects at the forefront of sustainable infrastructure development in Cameroon. The ILID Innovation Lab serves as a collaborative hub where STEM students and innovators refine their ideas, develop practical skills, and create sustainable solutions to address critical challenges. Embracing the core principles of innovation, sustainability, and community empowerment, the contest serves as a dynamic platform for visionaries and changemakers to present transformative solutions that address the pressing real-world challenges our nation faces today.",
