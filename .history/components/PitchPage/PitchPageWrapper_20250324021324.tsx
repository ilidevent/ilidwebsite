...
const PitchPageWrapper = () => {
  ...
  const whoContent = {
    ...
    keywords: ["Who"],
    text: "Calling all passionate STEM students ready to tackle critical infrastructure challenges and drive community transformation. Application deadline April 12, 2025, at exactly 11:59 pm",
    buttonData: {
      name: "Apply for Innovation Lab",
      link: "https://shorturl.at/UNNe5",
      target: "_blank"
