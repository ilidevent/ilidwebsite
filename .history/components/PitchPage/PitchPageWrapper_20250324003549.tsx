...
const PitchPageWrapper = () => {
  ...
  const HeroContent = {
    ...
    normalText:
      "Participate in the Innovation Lab, pitch your innovative idea, and unlock the opportunity to secure essential funding for its development.",
    buttonProps: {
  ...
  const whoContent = {
    ...
    keywords: ["Who"],
    text: "Calling all passionate STEM students ready to tackle critical infrastructure challenges and drive community transformation.",
    buttonData: {
      name: "Apply for Innovation Lab",
      link: "https://shorturl.at/UNNe5",
      target: "_blank"
  ...
  const highlighttwo = {
    text: "We are looking for passionate STEM (Science, Technology, Engineering, and Mathematics) with strong dedication to solving real-world problems our communities are facing. The aim is to empower these few to lead the youth involvement in accelerating context-based infrastructure solutions in Cameroon.",
    keyPhrases: ["STEM (Science, Technology, Engineering, and Mathematics)", "strong dedication"],
  };
