...
const PitchPageWrapper = () => {
  ...
  const HeroContent = {
    ...
    normalText:
      "Participate in the Innovation Lab, pitch your innovative idea, and unlock the opportunity to secure essential funding for its development. Application deadline April 12, 2025, at exactly 11:59 pm",
    buttonProps: {
  ...
  const pitchContent = {
    ...
    keywords: ["About"],
    text: "Participants are invited to delve deep into the critical areas affecting our communities. Application deadline April 12, 2025, at exactly 11:59 pm",
    buttonData: {
      name: "Apply for Innovation Lab",
      link: "https://shorturl.at/UNNe5",
      target: "_blank"
  ...
  const whoContent = {
    ...
    keywords: ["Who"],
    text: "Calling all passionate STEM students ready to drive community transformation. Application deadline April 12, 2025, at exactly 11:59 pm",
    buttonData: {
      name: "Apply for Innovation Lab",
      link: "https://shorturl.at/UNNe5",
      target: "_blank"
