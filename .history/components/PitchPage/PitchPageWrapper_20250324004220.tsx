...
const PitchPageWrapper = () => {
  ...
  const highlighttwo = {
    text: "The Innovation Lab os for passionate STEM (Science, Technology, Engineering, and Mathematics) with strong dedication to solving real-world problems our communities are facing. The aim is to empower these few to lead the youth involvement in accelerating context-based infrastructure solutions in Cameroon.",
