...
const PartnersForm = () => {
  ...
  const toggleSelectedItem = (selection: string) => {
    ...
    if (newSelectionselection !== "Please select") {
      setSelectError(false);
      ...
      if (selection.toLowerCase().includes("sponsorship")) {
        setButtonText("Apply to sponsor");
      } else if (selection.toLowerCase().includes("partnership")) {
        setButtonText("Apply to partner");
      } else {
        // fallback (if needed)
        setButtonText(`Apply to ${selection.toLowerCase()}`);
      }
    }
  };
        ...
        <div className={styles.form__top}>
          <div className={styles.form__boxing}>
            <div className={styles.form__forms}>
              ...
              <FormSelector selections={selections} selectedItem={selectedItem} labeler="What is your Inquiry?*" errorMessage="Please select an inquiry" selectError={selectError} toggleSelectedItem={toggleSelectedItem}/>
            </div>
