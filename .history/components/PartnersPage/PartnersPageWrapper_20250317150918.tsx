...
const PartnersPageWrapper = () => {
  ...
  const opportunityContent = {
    ...
    keywords: ["Why"],
    text: "ILID offers a unique opportunity to be part of a transformative initiative aimed at reshaping Cameroon's infrastructure. By sponsoring or patnering, you'll gain from:",
    buttonData: {
