        ...
        <div className={styles.form__top}>
          <div className={styles.form__boxing}>
            <div className={styles.form__forms}>
              ...
              <FormSelector selections={selections} selectedItem={selectedItem} label="What is your Inquiry?*" errorMessage="Please select an inquiry" selectError={selectError} toggleSelectedItem={toggleSelectedItem}/>
            </div>
