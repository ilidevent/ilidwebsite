        ...
        <div className={styles.form__top}>
          <div className={styles.form__boxing}>
            <div className={styles.form__forms}>
              ...
              <FormSelector selections={selections} selectedItem={selectedItem} setSelectedItem={setSelectedItem} selectError={selectError} toggleSelectItem={toggleSelectedItem}/>
            </div>
