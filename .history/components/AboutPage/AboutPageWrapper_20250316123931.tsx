...
const AboutPageWrapper = () => {
  ...
  const quickContent = {
    ...
    text: "A movement that engages the innovative spirit and drive of young Cameroonians to 
produce sustainable and practical solutions for critical problems.",
    buttonData: {
      name: "Secure my spot at ILID 2025",
      link: "/attend",
    },
