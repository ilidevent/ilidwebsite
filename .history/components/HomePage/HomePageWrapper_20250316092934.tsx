...
const HomePageWrapper = () => {
  ...
  const HeroContent = {
    ...
    normalText:
      "ILID supports STEM students in solving real infrastructure issues through sustainable innovation and practical measures. Together, we are converting ideas into actions that have a lasting effect on our communities.",
