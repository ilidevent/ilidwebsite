...
const HomePageWrapper = () => {
  ...
  return (
    <>
      ...
      <ReusableSection header={opportunityContent.header} keywords={opportunityContent.keywords} text={opportunityContent.text} textColor="#000000" backgroundColor="#FFF6ED" buttonData={opportunityContent.buttonData}>
        <OpportunityWrapperWrapper/>
      </ReusableSection>
      <SloganBanner/>
    </>
  );
