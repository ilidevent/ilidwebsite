...
const HomePageWrapper = () => {
  ...
  const HeroContent = {
    ...
    normalText:
      "ILID helps STEM students to confront real-world infrastructure problems with sustainable solutions and practical efforts. Together, we are converting ideas into actions that have a lasting effect on our communities.",
