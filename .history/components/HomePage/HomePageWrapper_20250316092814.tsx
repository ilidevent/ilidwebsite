...
const HomePageWrapper = () => {
  ...
  const HeroContent = {
    ...
    normalText:
      "ILID helps STEM students address real-world infrastructure challenges by promoting sustainable innovation and hands-on solutions. Together, we are converting ideas into actions that have a lasting effect on our communities.",
