...
const HomePageWrapper = () => {
  ...
  const faqContent = {
    ...
    keywords: ["Frequently"],
    text: "Explore our FAQ for essential insights to ensure a successful ILID experience. If your 
questions aren’t answered here, contact us at info@ilidevent.com.",
    buttonData: {
      name: "Secure my spot at ILID 2025",
      link: "/attend",
    },
