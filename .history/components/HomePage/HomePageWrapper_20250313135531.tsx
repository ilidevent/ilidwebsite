...
const HomePageWrapper = () => {
  ...
  return (
    <>
      ...
      <ReusableSection header={opportunityContent.header} keywords={opportunityContent.keywords} text={aboutContent.text} textColor="#000000" backgroundColor="#FFF6ED" buttonData={aboutContent.buttonData}>
        <AboutboxWrapper/>
      </ReusableSection>
      <SloganBanner/>
    </>
