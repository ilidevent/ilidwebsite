...
const HomePageWrapper = () => {
  ...
  const countDownContent = {
    ...
    text: "A huge thank-you to everyone who joined us! We hope you walked away energized by our inspiring sessions, hands-on labs, and new connections that will turn ideas into action. Stay tuned for session recordings, photo highlights, and details on next year’s event."
    buttonData: {
      name: "Register for summit",
      link: "https://shorturl.at/zfxQQ",
      target: "_blank",
