...
const HomePageWrapper = () => {
  ...
  const HeroContent = {
    ...
    normalText:
      "ILID helps STEM students address real-world infrastructure challenges by promoting sustainable innovation and hands-on solutions. Together, we transform ideas into actions that make a meaningful difference in our communities.",
