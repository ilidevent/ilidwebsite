...
const HomePageWrapper = () => {
  ...
  const agendaContent = {
    ...
    keywords: ["Agenda"],
    text: "Immerse yourself in four days of learning, innovation, and networking. Agendaetails are yet to be confirmed and will be communicated as soon as possible.",
    buttonData: {
      name: "Register for summit",
      link: "/attend",
    },
