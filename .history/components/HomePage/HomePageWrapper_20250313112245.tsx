...
const HomePageWrapper = () => {
  ...
  const aboutContent = {
    ...
    keywords: ["About"],
    text: " ILID 2025 is a groundbreaking four day event tackling critical infrastructure challenges in our communities. By empowering STEM students and young professionals, ILID fosters 
innovative solutions for sustainable development and resilience."
  }
  ...
  return (
    <>
      ...
      <VenueBanner/>
      <ReusableSection header="About ILID 2025" keywords={["About"]} text>
