...
const HomePageWrapper = () => {
  ...
  const HeroContent = {
    ...
    normalText:
      "ILID enables STEM students to confront real infrastructure problems with sustainable solutions and practical efforts. Together, we are converting ideas into actions that have a lasting effect on our communities.",
