...
const HomePageWrapper = () => {
  ...
  const agendaContent = {
    ...
    keywords: ["Agenda"],
    text: "Immerse yourself in four days of learning, innovation, and networking. Agenda details are yet to be confirmed and will be communicated as soon as possible.",
    buttonData: {
      name: "Register for summit",
      link: "https://shorturl.at/zfxQQ",
      target: "_blank"
  ...
  const countDownContent = {
    ...
    text: "ILID 2025 is now live! Dive into inspiring sessions, hands-on labs, and networking moments that spark innovative ideas and forge lasting partnerships."
    buttonData: {
      name: "Register for summit",
      link: "https://shorturl.at/zfxQQ",
      target: "_blank"
