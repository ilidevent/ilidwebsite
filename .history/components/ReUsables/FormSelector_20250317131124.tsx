...
const FormSelector = ({selections, selectdItem, setSelectedItem}: {selections: string[], selectedItem: string, setSelectedItem: React.Dispatch<React.SetStateAction<string>>}) => {
  const selections = [
    "Please select",
    "Sponsorship",
    "Partnership"
