...
const AccordionModal = ({activeModal, setActiveModal, agenda, date}: {agenda: AgendaItem , activeModal: boolean, setActiveModal: React.Dispatch<React.SetStateAction<boolean>>}) => {
  const buttonInfo = {
    name: "Secure my spot",
    link: "/attend",
  };
