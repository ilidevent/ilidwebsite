...
const AgendaAccordion = ({data, date, abbreviations}: {data: AgendaItem, date: string, abbreviations: string[]}) => {
  ...
  return (
    <>
      <div className={styles.aa__wrapper}>
        <div className={styles.aaw__left}>
          <div className={styles.al__date}>
            ...
            <span className={styles.aw__date}>{abbreviations[0]}</span>
          </div>
          ...
          <div className={styles.aw__details}>
            ...
            <div className={styles.aw__infoone}>
              ...
              <p className={styles.aw__text}>{data.}</p>
            </div>
          </div>
        </div>
        <div className={styles.aaw__right}>
          <div className={styles.awr__left}>
            <p className={styles.arl__text}>Pannel Discussion 3</p>
            <div className={styles.speaker__images}>
              {speakers.map((data, i) => (
                ...
                >
                  <Image fill quality={100} alt="Speaker Name" src={data} />
                </div>
              ))}
            </div>
          </div>
      ...
      <AccordionModal activeModal={activeModal} setActiveModal={setActiveModal} />
    </>
  );
};
