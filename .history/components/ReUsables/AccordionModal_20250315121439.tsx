...
const AccordionModal = ({activeModal, setActiveModal}: {activeModal: boolean, setActiveModal: React.Dispatch<React.SetStateAction<boolean>>}) => {
  const buttonInfo = {
    name: "Secure my spot",
    link: "/attend",
  };
  ...
  return (
    <div className={`${styles.modal__wrapper} ${activeModal ? styles.active}`}>
