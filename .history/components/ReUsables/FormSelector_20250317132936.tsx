...
const FormSelector = ({selections, selectedItem, setSelectedItem, selec}: {selections: string[], selectedItem: string, setSelectedItem: React.Dispatch<React.SetStateAction<string>>}) => {
