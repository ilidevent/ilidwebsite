  ...
  return (
    <>
      <motion.div
        ...
        animate="enter"
        exit="closed"
        className={`${styles.aa__wrapper} ${data.break ? styles.oactive : ""}`}
      >
        ...
        <div className={styles.aaw__right}>
          <div className={styles.awr__left}>
            ...
            <div className={styles.phone__version}>
              <div className={styles.aw__infoonetime}>
                <span className={styles.aw__svg}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                      fill="#000"
            ...
            {data.break && <p className={styles.break__p}>BREAK</p>}
            {!data.break && !data.panelist && <p className={styles.s2name}>{data.s2name}</p>}
          </div>
