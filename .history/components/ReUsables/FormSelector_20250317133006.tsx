...
const FormSelector = ({selections, selectedItem, setSelectedItem, selectError}: {selections: string[], selectedItem: string, setSelectedItem: React.Dispatch<React.SetStateAction<string>>, selectError: boolean, toggle}) => {
