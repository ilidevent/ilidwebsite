...
const AccordionModal = ({activeModal, setActiveModal, agenda, date}: {agenda: AgendaItem , date: string, activeModal: boolean, setActiveModal: React.Dispatch<React.SetStateAction<boolean>>}) => {
  const buttonInfo = {
    name: "Secure my spot",
    link: "/attend",
  };
        ...
        <div className={styles.am__left}>
          <div className={styles.al__topone}>
            ...
            <div className={styles.al__infoone}>
              ...
              <p className={styles.al__text}>{agenda.}</p>
            </div>
          </div>
