...
const FormSelector = ({selections, selectedItem, setSelectedItem, selectError, toggleSelectedItem}: {selections: string[], selectedItem: string, setSelectedItem: React.Dispatch<React.SetStateAction<string>>, selectError: boolean, toggleSelectedItem: () => void}) => {
