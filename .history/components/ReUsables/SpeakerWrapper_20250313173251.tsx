  ...
  return (
    <div className={styles.sb__wrapper}>
      <div className={styles.work__buttons}>
        <div className={styles.wbuttons} onClick={() => setActiveButton("speakers")}>Speakers</div>
        <div className={styles.wbuttons} onClick={() => setActiveButton("workshops")}>Workshops</div>
      </div>
