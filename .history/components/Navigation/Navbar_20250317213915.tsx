...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    if (navigation) {
      ...
      gsap.set(navigation, { clipPath: "polygon(0% 0%, 100% 0%, 100% 102%, 0% 102%)", background: "transparent" });
      ...
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          ...
          if (self.scroll() < 600) {
            gsap.to(navigation, { clipPath: "polygon(0% 0%, 100% 0%, 100% 102%, 0% 102%)", background: "transparent", duration: 0.5});
          } else {
            ...
            if (self.direction === 1 && self.scroll() > lastScroll) {
              ...
              gsap.to(navigation, { clipPath: "polygon(0% 0%, 100% 0%, 100% 0%, 0% 0%)", duration: 0.5 });
            } else if (self.direction === -1 && self.scroll() < lastScroll) {
              // Scrolling up: show nav.
              gsap.to(navigation, { clipPath: "polygon(0% 0%, 100% 0%, 100% 102%, 0% 102%)", duration: 0.5});
            }
          }
