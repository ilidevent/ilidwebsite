    ...
    >
      ...
      >
        ...
        <div className={styles.b__contact}>
          <div className={styles.bc__svg}
            onClick={() => setActiveBetter(false)}
          ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <path fill="#FFF6ED" fillRule="evenodd" d="M420.48 121.813L390.187 91.52L256 225.92L121.813 91.52L91.52 121.813L225.92 256L91.52 390.187l30.293 30.293L256 286.08l134.187 134.4l30.293-30.293L286.08 256z"></path>
        </svg></div>
