...
const Navbar = ({ animationFinished }: { animationFinished: boolean }) => {
  const navLinks = [
    {
      name: "Attend",
      link: "/attend",
      ...
      <header className={`nav__translate ${styles.nav__header}`} ref={Navbar}>
        <div className={`container ${styles.nav__container}`}>
          ...
          <nav className={styles.nav__right}>
            <div className={styles.pitch__button}>
              <Button fill={false} buttonInfo={buttonOne} />
            </div>
            <div className={styles.partner__button}>
              <Button fill buttonInfo={buttonTwo} />
            </div>
            <div className={styles.menu__wrapper} onClick={() => setActiveSide(true)}>
