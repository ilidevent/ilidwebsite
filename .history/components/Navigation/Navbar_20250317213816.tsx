    ...
    if (navigation) {
      ...
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          ...
          if (self.scroll() < 600) {
            gsap.to(navigation, { clipPath: "polygon(0% 0%, 100% 0%, 100% 102%, 0% 102%)", background: "transparent", duration: 0.5, ease: "none" });
          } else {
            ...
            if (self.direction === 1 && self.scroll() > lastScroll) {
              ...
              gsap.to(navigation, { clipPath: "polygon(0% 0%, 100% 0%, 100% 102%, 0% 102%)", duration: 0.3, ease: "none" });
            }
          }
