...
const BetterMarque = ({
  ...
  const betterText =
    "The key to Better Marque's success lies in our ability to deliver unique experiences to our end clients. We are committed to helping you leave a lasting impression.";
    ...
    >
      ...
      >
        ...
        <div className={styles.b__contact}>
          ...
          <Link href="https://wa.me/+237693370638" target="_blank">Get in touch</Link>
        </div>
      </div>
      <div className={styles.bc__content}>
        ...
        <div
          ...
          ref={footerRef}
        >
          <Link href="https://www.bettermarque.com" target="_blank" className={styles.coming}>
            Website
          </Link>
          <div className={styles.button}>
            <Link href="https://www.instagram.com/bettermarque/" target="_blank">
              Instagram
            </Link>
            <Link href="https://web.facebook.com/profile.php?id=61555159313413" target="_blank">
              Facebook
            </Link>
          </div>
        </div>
