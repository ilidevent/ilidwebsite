...
const Footer = () => {
  ...
  const navTwo = [
    { name: "Apply for Lab", link: "/pitch-contest" },
    { name: "Team", link: "/team" },
    ...
    <footer className={styles.footer__section}>
      <div className={`container ${styles.footer__container}`}>
        <div className={styles.footer__top}>
          <div className={styles.ft__top}>
            ...
            <p className={styles.loca__venue}>
              ...
              <br />
              <span>Yaounde, Cameroon. SINAHA Hotel & MBOA HUB</span>
            </p>
          </div>
          ...
          <div className={styles.ft__bottom}>
            <div className={styles.ftb__left}>
              ...
              <div className={styles.svg__container}>
                <Link href="https://www.instagram.com/ilid.event" className={styles.svg} target="_blank">
                ...
                <Link href="https://www.linkedin.com/company/innovation-lab-for-infrastructure-development/" className={styles.svg} target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    <path
                      fill="#FFF6ED"
                ...
                <Link href="https://www.facebook.com/share/1PgCT3pVLy/" className={styles.svg} target="_blank">
                  <svg
                ...
                <Link href="https://www.x.com" className={styles.svg} target="_blank">
        ...
        <div className={styles.footer__bottom}>
          <span>#ILID{year} All Rights Reserved</span>
          <p>
