...
const Preloader = ({
  ...
  useEffect(() => {
    ...
    switch (pathname) {
      ...
      case "/partners":
        ...
        break;
      case "/speakers":
        setPageName("Speakers & Facilitators");
        break;
      case "/agenda":
    ...
    const updateCounter = () => {
      setCurrentValue((prev) => {
        if (prev < 100) {
          ...
          const delay = Math.floor(Math.random() * 200) + 70;
  ...
  }, [finished, twoFinished, pathname, setAnimation]);
      ...
      {pathname === "/" ? (
        <div className={styles.preload__home}>
          <div className={styles.ilid}>
            <AnimatedPhrase
              set2Finished={set2Finished}
              phrase="Innovation Lab for Infrastructure Development"
            />
          </div>
