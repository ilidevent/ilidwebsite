            ...
            {TeamMembersData.map((data, i) => (
              ...
              >
                {data.imageData.image ? (
                  ...
                  <div className={styles.si__prev}>
                    <span>{data.imageData.abbv}</span>
                  </div>
                )}
      ...
      >
        <div className={styles.modal__main}>
          <div className={styles.tm__top}>
            {
              activeTeamData.imageData.image ? 
            <div className={styles.mimage}>
              ...
              />
            </div> : <div className={styles.si__prev2}>
                    <span>{activeTeamData.imageData.abbv}</span>
                  </div>
            }
          ...
          {activeTeamData.linkData && (
            <div className={styles.in__profile}>
              <Link href={activeTeamData.linkData.link}>
                {activeTeamData.linkData.name}
              </Link>
            </div>
          )}
