...
const TeamPageWrapper = () => {
  ...
  const sectionContent = {
    ...
    keywords: ["Secure"],
    text: "Get to know the team working collaboratively behind the scenes to help overcome infrastructure problems and foster sustainable progress for our communities.",
  };
