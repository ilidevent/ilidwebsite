...
const TeamPageWrapper = () => {
  ...
  const HeroContent = {
    ...
    normalText2:
      "Get to know the team working collaboratively behind the scenes to overcome infrastructure problems and foster sustainable progress for our communities.",
    buttonProps: {
      name: "Secure my spot",
    },
  };
