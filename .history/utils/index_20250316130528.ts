...
const quickStoryData = [
  ...
  },
  {
    ...
    keyPhrases: ["what we can do", "what we're allowed to do", "design thinking"]
  },
  {
    text: "So, we started assembling a team—other dedicated individuals who share our vision for change. That’s how ILID 2025 was born. We’re not just planning an event; we’re creating a platform where young minds can come together, think critically, and develop real solutions for Cameroon’s infrastructure problems.",
    keyPhrases: ["ILID 2025"]
  },
  {
    ...
    keyPhrases: ["every stakeholder involved benefits from this venture.", "strengthen the link between students and the private sector"]
  },
  {
    ...
    keyPhrases: [
      "National Professional Orders like ONIGC and ONAC", "a future where young innovators play an active role in shaping the infrastructure of their country."
    ]
  }
]
